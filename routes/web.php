...
Route::middleware(['auth'])->group(function () {
    ...
    Route::prefix('tasks')->group(function () {
        ...
        Route::post('/{task}/done', [DoController::class, 'done'])->name('tasks.done');
    ...
    Route::prefix('reminders')->group(function () {
        ...
        Route::get('/due', [ReminderController::class, 'due'])->name('reminders.due');
    });
    ...
    // Analytics routes
    Route::get('/analytics/weekly', [AnalyticsController::class, 'weekly'])->name('analytics.weekly');
